...
export const Roadmap = () => {
    return (
        <>
        <h1 className='mt-32 mb-4 align-middle font-abel subpixel-antialiased text-4xl text-center font-bold'>CAREER_TIMELINE</h1>
            <div id='timeline' className="pt-4 pb-16 mb-32 align-middle justify-center max-w-xl mx-auto bg-coolGray-50 rounded-md shadow-2xl items-center">

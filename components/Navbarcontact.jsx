      ...
      <nav id="navbar" className={navbar ? 'dark-bg shadow-lg sticky top-0 z-50 transition-duration-400' : ''}>
          ...
          <div className="flex justify-center">
            <div className="flex space-x-16">
              <div className="hidden md:flex items-center space-x-1">
                ...
                <Link href={"/projects"} as={"/projects"} passHref><a className="font-abel text-lg py-2 px-6 text-coolGray-300 font-semibold hover:text-teal-100 transition duration-300 border-b-2 hover:border-teal-400">Projects</a></Link>
              </div>
            </div>
        ...
        <div className="hidden mobile-menu">
          <ul className="">
            ...
            <Link href={"/projects"} as={"/projects"} passHref><li><a className="text-coolGray-300 font-abel subpixel-antialiased text-md text-center font-bold block px-2 py-4 bg-gradient-to-r hover:from-teal-500 hover:via-blue-600 hover:to-purple-600 transition duration-300">Projects</a></li></Link>
          </ul>
        </div>
      </nav>
    </>

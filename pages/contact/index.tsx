...
function Contact() {
    ...
    <Navbar/>
            ...
            <form className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl md:col-span-8 mt-5 pt-8 pb-1 px-8 mx-4 xl:mx-80">
                ...
                <textarea onChange={(e)=>{setMessageContent(e.target.value)}} rows={10} className="appearance-none bg-transparent border-b border-teal-500 w-full text-gray-700 mr-3 p-4 focus:bg-gray-200 leading-tight focus:outline-none" placeholder="Your message goes here." aria-label="Full name">
                </textarea>
                </div>
